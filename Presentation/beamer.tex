...
\begin{frame}{Console}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{atari2600.png} % Adjust the size as needed
...
\begin{frame}{Cathode Ray Tube Televisions}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{monitor.png} % Adjust the size as needed
...
\begin{frame}{TIA}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{screen_whole.png} % Adjust the size as needed
...
\begin{frame}{TIA}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{TIA_diagram.png} % Adjust the size as needed
...
\begin{frame}{Code Example}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{assembly.png} % Adjust the size as needed
...
\begin{frame}{Fireworks}
    \begin{figure}
        \centering
        \includegraphics[width=0.6\textwidth]{cover.jpg} % Adjust the size as needed
...
\begin{frame}{Fireworks}
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{gameImage.png} % Adjust the size as needed
